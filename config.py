...
# Gemini API 설정
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyDxPwUrvGHzmghDomx9q-NX9gDtZDbxNWQ")  # 환경 변수에서 가져오기
GEMINI_MODEL = "gemini-3.0-flash-preview"  # 사용할 모델명
...
# MuMu Player 창 설정
WINDOW_TITLE_PATTERN = "콘텐츠페이"  # 또는 "MuMu"  # MuMu Player 창 제목 패턴
...
PHYSICS_GRAVITY = (0, 900)  # 중력 (x, y) - y축 아래 방향이 양수
...
DEBUG_LOG_LEVEL = "INFO"      # 로그 레벨: DEBUG, INFO, WARNING, ERROR
