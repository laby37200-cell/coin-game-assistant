...
class CoinType(Enum):
    ...
    BLACK_THUNDER = (1, "검정번개", 20, 10, (50, 50, 50))           # 가장 작음
    PINK_CIRCLE = (2, "핑크동전", 25, 20, (255, 150, 180))
    ORANGE_CIRCLE = (3, "주황동전", 30, 40, (255, 140, 100))
    YELLOW_CIRCLE = (4, "노랑동전", 35, 80, (255, 220, 100))
    MINT_CIRCLE = (5, "민트동전", 40, 160, (150, 255, 200))
    BLUE_CIRCLE = (6, "파랑동전", 50, 320, (100, 180, 255))        # 랜덤 최대
    PURPLE_CIRCLE = (7, "보라동전", 60, 640, (180, 120, 255))
    BROWN_CIRCLE = (8, "갈색동전", 70, 1280, (150, 100, 70))
    WHITE_SQUARE = (9, "흰색상자", 85, 2560, (240, 240, 240))
    YELLOW_BULB = (10, "노랑전구", 100, 5120, (255, 230, 100))
    MINT_GIFTBOX = (11, "민트선물상자", 120, 10240, (120, 255, 200))  # 가장 큼, 최종 목표
